...
public class CrediterokForm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CrediterokForm frame = new CrediterokForm();
	...
	public CrediterokForm() {
		...
		JLabel lblNewLabel = new JLabel("Le Credit a été effectué  ");
